...
function [injec timelist]=so2injection_8boxes(h1lim,h2lim,latlim,so2mass,eruheight,erulat,erudate,erutropo)
...
timelist=erudate-1;
so2mass=(0.50052)*so2mass; %convert mass from kt so2 to tg of S
